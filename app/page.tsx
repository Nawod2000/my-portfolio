...
export default function Home() {
  ...
  return (
    <>
      {/*
        Navbar is placed OUTSIDE <main> as a direct sibling.
        On iOS Safari/Chrome, a position:fixed element nested inside a
        scrollable <main> gets its touch events swallowed by the scroll
        handler. Moving it out of <main> fixes this entirely.
      */}
      <div className="fixed top-4 left-0 right-0 z-[99999] w-full px-4 md:px-0">
